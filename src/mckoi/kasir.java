...
public class kasir extends JInternalFrame {
	...
	public kasir() {
		setFrameIcon(new ImageIcon("D:\\PBO_UAS_1\\mckoi\\images\\png_login\\b.png"));
		autoDtrans();
		this.setTitle("Kasir");
		setBounds(100, 100, 866, 600);
		getContentPane().setLayout(null);
		lblNamaPembeli = new JLabel("Nama Pelangan :");
		...
		btnCari.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        try {
		            Connection konek = connect.getCon();
		            Statement st = konek.createStatement();
		            ResultSet rs = st.executeQuery("select Nama,harga from produk where id='"+id+"'");
		            while (rs.next()) {
		...
		spinner.setBounds(132, 417, 63, 20);
		panel.add(spinner);
		...
		btnTambah.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        try{
		        Connection konek = connect.getCon();
		        String query = "UPDATE stok SET stok_produk = stok_produk-? WHERE id = ?";
		        PreparedStatement prepare = konek.prepareStatement(query);
		...
		lblTotal = new JLabel("Total Pembayaran :");
		lblTotal.setEnabled(false);
		lblTotal.setBounds(505, 327, 108, 14);
		panel.add(lblTotal);
		...
		lblJumlahBarang.setBounds(505, 358, 95, 14);
		...
		lblBayar = new JLabel("Uang Pelanggan :");
		lblBayar.setEnabled(false);
		lblBayar.setBounds(505, 389, 108, 14);
		panel.add(lblBayar);
		
		textField_1 = new JTextField();
		textField_1.setEnabled(false);
		textField_1.setBounds(712, 386, 108, 20);
		panel.add(textField_1);
		textField_1.setColumns(10);
		
		lblRp = new JLabel("Rp.");
		lblRp.setBounds(680, 389, 23, 14);
		panel.add(lblRp);
		...
		btnHitung.setBounds(617, 448, 89, 23);
		panel.add(btnHitung);
